...
return{
	get_all_vehicles: function(req, res){
		console.log("GETTING ALL VEHICLES FROM BLOCKCHAIN.... ");
	...
	add_vehicle: function(req, res){
		console.log("CREATING NEW VEHICLE............. ");

		var array = req.params.vehicle.split("-");
		console.log(array);
		...
		var owner = array[2]
		var color = array[3]
		var chasisnumber = array[4]
		var enginenumber = array[5]
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    const request = {
		        ...
		        chaincodeId: 'VLM',
		        fcn: 'createVehicle',
		        args: [make, model, owner, color, chasisnumber, enginenumber],
		        chainId: 'mychannel',
		        txId: tx_id
		    };
	...
	query_vehicle: function(req, res){
	...
	get_history_vehicle: function(req, res){
	...
	change_owner: function(req, res){
		console.log("CHANGING THE OWNERSHIP OF VEHICLE.... ");
